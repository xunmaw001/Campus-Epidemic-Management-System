    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请理由" prop="waichuText">
                        <el-input type="textarea"  :readonly="ro.waichuText" v-model="ruleForm.waichuText" placeholder="申请理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.waichuText" label="申请理由" prop="waichuText">
                            <span v-html="ruleForm.waichuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="交通工具" prop="waichuTypes">
                        <el-select v-model="ruleForm.waichuTypes" :disabled="ro.waichuTypes" placeholder="请选择交通工具">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="交通工具" prop="waichuValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="去哪里" prop="waichuMudidi">
                       <el-input v-model="ruleForm.waichuMudidi"
                                 placeholder="去哪里" clearable  :readonly="ro.waichuMudidi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="去哪里" prop="waichuMudidi">
                           <el-input v-model="ruleForm.waichuMudidi"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="地址" prop="waichuChufadi">
                       <el-input v-model="ruleForm.waichuChufadi"
                                 placeholder="地址" clearable  :readonly="ro.waichuChufadi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="地址" prop="waichuChufadi">
                           <el-input v-model="ruleForm.waichuChufadi"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="身体状态" prop="waichuShentiTypes">
                        <el-select v-model="ruleForm.waichuShentiTypes" :disabled="ro.waichuShentiTypes" placeholder="请选择身体状态">
                            <el-option
                                v-for="(item,index) in waichuShentiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="身体状态" prop="waichuShentiValue">
                        <el-input v-model="ruleForm.waichuShentiValue"
                            placeholder="身体状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.waichuChufaTime"  class="input" label="出发时间" prop="waichuChufaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.waichuChufaTime"
                                type="date"
                                placeholder="出发时间"
                                :disabled="ro.waichuChufaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.waichuChufaTime" label="出发时间" prop="waichuChufaTime">
                            <span v-html="ruleForm.waichuChufaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.waichuDaodaTime"  class="input" label="到达时间" prop="waichuDaodaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.waichuDaodaTime"
                                type="date"
                                placeholder="到达时间"
                                :disabled="ro.waichuDaodaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.waichuDaodaTime" label="到达时间" prop="waichuDaodaTime">
                            <span v-html="ruleForm.waichuDaodaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.waichuYesnoTypes" label="申报状态" prop="waichuYesnoTypes">
                        <el-input v-model="ruleForm.waichuYesnoValue" placeholder="申报状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.waichuYesnoText" label="审核回复" prop="waichuYesnoText">
                        <span v-html="ruleForm.waichuYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.waichuShenheTime" label="审核时间" prop="waichuShenheTime">
                        <span v-html="ruleForm.waichuShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    waichuMudidi: false,
                    waichuChufadi: false,
                    waichuShentiTypes: false,
                    waichuChufaTime: false,
                    waichuDaodaTime: false,
                    waichuYesnoTypes: false,
                    waichuYesnoText: false,
                    waichuShenheTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                waichuTypesOptions : [],
                waichuShentiTypesOptions : [],
                waichuYesnoTypesOptions : [],
                laoshiOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=waichu_shenti_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.waichuShentiTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=waichu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.waichuYesnoTypesOptions = data.data.list;
                    }
                });
