    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康码打卡" prop="meiridakaName">
                       <el-input v-model="ruleForm.meiridakaName"
                                 placeholder="健康码打卡" clearable  :readonly="ro.meiridakaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康码打卡" prop="meiridakaName">
                           <el-input v-model="ruleForm.meiridakaName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.meiridakaFile" label="健康码照片" prop="meiridakaFile">
                        <file-upload
                                tip="点击上传健康码照片"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.meiridakaFile?$base.url+ruleForm.meiridakaFile:''"
                                @change="meiridakaFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.meiridakaFile" label="健康码照片" prop="meiridakaFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.meiridakaFile"  >健康码照片下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体温" prop="meiridakaWendu">
                       <el-input v-model="ruleForm.meiridakaWendu"
                                 placeholder="体温" clearable  :readonly="ro.meiridakaWendu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="体温" prop="meiridakaWendu">
                           <el-input v-model="ruleForm.meiridakaWendu"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="meiridakaText">
                        <el-input type="textarea"  :readonly="ro.meiridakaText" v-model="ruleForm.meiridakaText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.meiridakaText" label="备注" prop="meiridakaText">
                            <span v-html="ruleForm.meiridakaText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    meiridakaName: false,
                    meiridakaFile: false,
                    meiridakaWendu: false,
                    meiridakaText: false,
                    meiridakaDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                    laoshiId: '',
        ...
        methods: {
            ...
            //图片
            meiridakaFileUploadChange(fileUrls){
                this.ruleForm.meiridakaFile = fileUrls;
                this.addEditUploadStyleChange()
            },
